...
const FormAddNew = ({ handleCloseFormAddNew, isOpenFormAddNew }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const sortedDescription = orderedDays.filter((day) => formData.description.includes(day));
            ...
            <div className="relative w-full max-w-md bg-white rounded-lg shadow-lg p-5">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <label>
                        ...
                        <input name="shift" value={formData.shift} onChange={handleInputChange} type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 block w-full p-2.5" placeholder="Nhập ca làm" required />
                    ...
                    <label>
                        ...
                        <input name="time" value={formData.time} onChange={handleInputChange} type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 block w-full p-2.5" placeholder="Nhập thời gian" required />
                    ...
                    <label>
                        ...
                        <div className="relative">
                            <div className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg px-3 py-2.5 cursor-pointer select-none" onClick={() => setShowDayDropdown((prev) => !prev)}>
                                {formData.description.length > 0 ? formData.description.join(", ") : "-- Chọn ngày làm --"}
                            </div>
                        ...
                        {error.name === "description" && <p className="text-red-500 text-sm mt-1">{error.message}</p>}
                    </label>
                </form>
